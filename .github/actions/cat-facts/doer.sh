...
cat urls | xargs -n1 -P 10 -I {} bash -c ' python3 /all/ps/paramspider.py --domain {} --level high --silent >/dev/null; cat output/{}.txt' | xargs -n1 -P10 -I% bash -c 'dalfox url % --silence'
